...
# Build a module from already-encoded section CONTENTS (each a byte list, or empty
# to omit). Section ids: 1 type, 2 import, 3 func, 4 table, 5 memory, 6 global,
# 7 export, 9 element, 10 code, 11 data.
fun module-of(type-c, import-c, func-c, table-c, mem-c, global-c, export-c, elem-c, code-c):
...
# import entry: module ++ name (utf8) ++ kind ++ desc(typeidx for func)
