...
**Bare** (unqualified) references to a colliding name are still resolved by program
order + arity, NOT made module-aware. Reason: the flat namespace has no per-reference
